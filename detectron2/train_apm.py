...
class APMEvaluator(COCOEvaluator):
    def __init__(self,*args,**kwargs):
        super(APMEvaluator, self).__init__(*args,**kwargs)
    ...
    def process(self, inputs, outputs):
        ...
        for input, output in zip(inputs, outputs):
            ...
            proposals = {}
            proposals["boxes"] = output.proposal_boxes.tensor.to(self._cpu_device)
            proposals["objectness_logits"] = output.objectness_logits.to(self._cpu_device)
            prediction["proposals"] = proposals
    ...
    def evaluate(self, img_ids=None):
        ...
        if self._output_dir:
            ...
            file_path = os.path.join(self._output_dir, "proposal_predictions.pth")
